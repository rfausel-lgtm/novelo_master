...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const fixed = ["", "/grafo", "/cronologia", "/coincidencias", "/pessoas", "/organizacoes", "/eventos", "/atos", "/documentos", "/fontes", "/atualizacoes", "/metodologia", "/politica-editorial", "/sobre", "/imprensa", "/perguntar", "/rede"];
