...
export const metadata: Metadata = pageMetadata({
  title: "Fontes",
  description:
    "Auditoria das fontes do corpus: origem, tipo, data, URL, verificação e o que cada fonte sustenta.",
  path: "/fontes",
});
  ...
  return (
    <PageShell>
      <PageTitle
        eyebrow="Auditoria"
        title="Fontes"
        lede={`${rows.length} fontes, ${official} primárias oficiais. Toda informação publicada aponta para uma fonte verificável; cada fonte mostra o que sustenta.`}
      />
      <SectionBanner variant="sources" />
