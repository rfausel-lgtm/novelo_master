...
export const GraphExplorerLoader = dynamic(
  () => import("./GraphExplorer").then((m) => m.GraphExplorer),
  {
    ssr: false,
    /*
    ...
    loading: () => (
      ...
      >
        <div
          aria-hidden="true"
          className="novelo-loading-bg pointer-events-none absolute inset-0"
        />
        <div className="relative w-full max-w-sm">
          <p className="text-fg text-sm font-medium">Montando o novelo…</p>
          <p className="text-fg-3 mt-1 text-xs">
            O mapa inteiro é baixado de uma vez para funcionar sem servidor. Enquanto isso, como
            lê-lo:
          </p>
