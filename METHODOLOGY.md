...
| Pista                    | `encyclopedic`, `blog`, `social_media`, `other`                                                                                                                                             | Wikipedia, blogs, redes sociais. Servem para localizar documentos; não sustentam sozinhas nenhuma classe acima de A. O lint emite aviso quando `blog` ou `social_media` aparece em evidência de classe D ou C — ou seja, quando a pista é usada como prova |
